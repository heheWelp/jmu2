...
export const metadata: Metadata = {
  title: 'Edit Course Feedback Settings'
}

export default async function EditCourseFeedbackSettingsPage({ 
  params 
}: {
  params: { id: string }
}) {
  ...
  // Return the dynamic course editor with the feedback-settings tab active
  return (
    <DynamicCourseEditor
      courseId={params_id}
      courseName={course.name}
      initialTab="feedback-settings"
      courseData={course}
